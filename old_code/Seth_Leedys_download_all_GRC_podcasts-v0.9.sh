...
function send_ping() {
	...
	wget -qb -O /dev/null -U "GRCDownloader_v$this_version" "http://techblog.sethleedy.name/do_count.php?datetime=$datetime&agent_code=GRCDownloader_v$this_version" 1>/dev/null 2>&1
